...
-file("/usr/local/erlang/lib/erlang/lib/parsetools-2.1.5/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
-dialyzer({nowarn_function, yeccgoto_appender/7}).
...
-dialyzer({nowarn_function, yeccgoto_appenders/7}).
...
-dialyzer({nowarn_function, yeccgoto_cutoff_level/7}).
yeccgoto_cutoff_level(0, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_5(5, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_logger/7}).
...
-dialyzer({nowarn_function, yeccgoto_loggers/7}).
...
-dialyzer({nowarn_function, yeccgoto_prop/7}).
...
-dialyzer({nowarn_function, yeccgoto_props/7}).

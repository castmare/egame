...
-export(['enum_symbol_by_value_login_reply.result'/1, 'enum_value_by_symbol_login_reply.result'/1]).
-export(['enum_symbol_by_value_create_role_reply.result'/1, 'enum_value_by_symbol_create_role_reply.result'/1]).
...
-type 'login_reply.result'() :: 'new_user' | 'default_role' | 'role_list'.
-type 'create_role_reply.result'() :: 'success' | 'nickname_repeat' | 'nickname_error' | 'nickname_dirty'.
-type 'team_member_state'() :: 'inviting' | 'unready' | 'ready'.
-export_type(['result'/0, 'login_reply.result'/0, 'create_role_reply.result'/0, 'team_member_state'/0]).

%% message types
-type name_card_st() :: #name_card_st{}.
-type role_st() :: #role_st{}.
-type cancel_match_reply() :: #cancel_match_reply{}.
-type start_match_reply() :: #start_match_reply{}.
...
-export_type(['name_card_st'/0, 'role_st'/0, 'cancel_match_reply'/0, 'start_match_reply'/0, 'match_reply'/0, 'team_member_st'/0, 'team_info_st'/0, 'team_reply'/0, 'select_magic_reply'/0, 'lookup_role_reply'/0, 'role_summary_st'/0, 'login_reply'/0, 'magic_reply'/0, 'select_role_reply'/0, 'create_role_reply'/0, 'role_reply'/0, 'notify_msg'/0, 'error_info'/0, 'down_msg'/0]).

-spec encode_msg(#name_card_st{} | #role_st{} | #cancel_match_reply{} | #start_match_reply{} | #match_reply{} | #team_member_st{} | #team_info_st{} | #team_reply{} | #select_magic_reply{} | #lookup_role_reply{} | #role_summary_st{} | #login_reply{} | #magic_reply{} | #select_role_reply{} | #create_role_reply{} | #role_reply{} | #notify_msg{} | #error_info{} | #down_msg{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#name_card_st{} | #role_st{} | #cancel_match_reply{} | #start_match_reply{} | #match_reply{} | #team_member_st{} | #team_info_st{} | #team_reply{} | #select_magic_reply{} | #lookup_role_reply{} | #role_summary_st{} | #login_reply{} | #magic_reply{} | #select_role_reply{} | #create_role_reply{} | #role_reply{} | #notify_msg{} | #error_info{} | #down_msg{}, list()) -> binary().
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      ...
      #cancel_match_reply{} ->
	  e_msg_cancel_match_reply(Msg, TrUserData);
      #start_match_reply{} ->
	  e_msg_start_match_reply(Msg, TrUserData);
...
e_msg_cancel_match_reply(_Msg, _TrUserData) -> <<>>.

e_msg_start_match_reply(_Msg, _TrUserData) -> <<>>.
...
e_msg_match_reply(#match_reply{start = F1, cancel = F2},
    ...
    B1 = if F1 == undefined -> Bin;
		...
		begin
		  TrF1 = id(F1, TrUserData),
		  e_mfield_match_reply_start(TrF1, <<Bin/binary, 10>>,
					     TrUserData)
		end
	 end,
    if F2 == undefined -> B1;
	   ...
	   begin
	     TrF2 = id(F2, TrUserData),
	     e_mfield_match_reply_cancel(TrF2, <<B1/binary, 18>>,
					 TrUserData)
	   end
    end.
...
e_msg_team_member_st(#team_member_st{role_id = F1,
...
e_msg_login_reply(#login_reply{result = F1,
    ...
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   'e_enum_login_reply.result'(TrF1, <<Bin/binary, 8>>)
	 end,
    B2 = begin
	   TrF2 = id(F2, TrUserData),
	   e_varint(TrF2, <<B1/binary, 16>>)
...
e_msg_create_role_reply(#create_role_reply{result = F1,
    ...
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   'e_enum_create_role_reply.result'(TrF1,
					     <<Bin/binary, 8>>)
	 end,
    if F2 == undefined -> B1;
       true ->
...
e_msg_notify_msg(_Msg, _TrUserData) -> <<>>.
...
e_msg_down_msg(#down_msg{error = F1, notify = F2,
			 login = F3, role = F4, magic = F5, team = F6,
			 match = F7},
	       Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
	    true ->
    ...
    B5 = if F5 == undefined -> B4;
		...
		begin
		  TrF5 = id(F5, TrUserData),
		  e_mfield_down_msg_magic(TrF5, <<B4/binary, 42>>,
					  TrUserData)
		end
	 end,
    B6 = if F6 == undefined -> B5;
		...
		begin
		  ...
		  e_mfield_down_msg_team(TrF6, <<B5/binary, 50>>,
					 TrUserData)
		end
	 end,
    if F7 == undefined -> B6;
	   ...
	   begin
	     ...
	     e_mfield_down_msg_match(TrF7, <<B6/binary, 58>>,
				     TrUserData)
	   end
    end.
...
e_mfield_match_reply_start(_Msg, Bin, _TrUserData) ->
    <<Bin/binary, 0>>.

e_mfield_match_reply_cancel(_Msg, Bin, _TrUserData) ->
    <<Bin/binary, 0>>.
...
e_mfield_down_msg_notify(_Msg, Bin, _TrUserData) ->
    <<Bin/binary, 0>>.
...
'e_enum_login_reply.result'(new_user, Bin) ->
    <<Bin/binary, 1>>;
'e_enum_login_reply.result'(default_role, Bin) ->
    <<Bin/binary, 2>>;
'e_enum_login_reply.result'(role_list, Bin) ->
    <<Bin/binary, 3>>;
'e_enum_login_reply.result'(V, Bin) -> e_varint(V, Bin).

'e_enum_create_role_reply.result'(success, Bin) ->
    <<Bin/binary, 0>>;
'e_enum_create_role_reply.result'(nickname_repeat,
				  Bin) ->
    <<Bin/binary, 1>>;
'e_enum_create_role_reply.result'(nickname_error,
				  Bin) ->
    <<Bin/binary, 2>>;
'e_enum_create_role_reply.result'(nickname_dirty,
				  Bin) ->
    <<Bin/binary, 3>>;
'e_enum_create_role_reply.result'(V, Bin) ->
    e_varint(V, Bin).
...
decode_msg(Bin, MsgName, Opts) when is_binary(Bin) ->
    ...
    case MsgName of
      ...
      cancel_match_reply ->
	  try d_msg_cancel_match_reply(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, cancel_match_reply,
			 {Class, Reason, StackTrace}}}})
	  end;
      start_match_reply ->
	  try d_msg_start_match_reply(Bin, TrUserData) catch
	    Class:Reason ->
		StackTrace = erlang:get_stacktrace(),
		error({gpb_error,
		       {decoding_failure,
			{Bin, start_match_reply, {Class, Reason, StackTrace}}}})
	  end;
      match_reply ->
...
d_msg_cancel_match_reply(Bin, TrUserData) ->
    dfp_read_field_def_cancel_match_reply(Bin, 0, 0,
					  TrUserData).

dfp_read_field_def_cancel_match_reply(<<>>, 0, 0, _) ->
    #cancel_match_reply{};
dfp_read_field_def_cancel_match_reply(Other, Z1, Z2,
				      TrUserData) ->
    dg_read_field_def_cancel_match_reply(Other, Z1, Z2,
					 TrUserData).

dg_read_field_def_cancel_match_reply(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_cancel_match_reply(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
dg_read_field_def_cancel_match_reply(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_cancel_match_reply(Rest, 0, 0, TrUserData);
      1 -> skip_64_cancel_match_reply(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_cancel_match_reply(Rest, 0, 0,
						   TrUserData);
      3 ->
	  skip_group_cancel_match_reply(Rest, Key bsr 3, 0,
					TrUserData);
      5 -> skip_32_cancel_match_reply(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_cancel_match_reply(<<>>, 0, 0, _) ->
    #cancel_match_reply{}.

skip_varint_cancel_match_reply(<<1:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    skip_varint_cancel_match_reply(Rest, Z1, Z2,
				   TrUserData);
skip_varint_cancel_match_reply(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, TrUserData) ->
    dfp_read_field_def_cancel_match_reply(Rest, Z1, Z2,
					  TrUserData).

skip_length_delimited_cancel_match_reply(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_cancel_match_reply(Rest, N + 7,
					     X bsl N + Acc, TrUserData);
skip_length_delimited_cancel_match_reply(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_cancel_match_reply(Rest2, 0, 0,
					  TrUserData).

skip_group_cancel_match_reply(Bin, FNum, Z2,
			      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_cancel_match_reply(Rest, 0, Z2,
					  TrUserData).

skip_32_cancel_match_reply(<<_:32, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_cancel_match_reply(Rest, Z1, Z2,
					  TrUserData).

skip_64_cancel_match_reply(<<_:64, Rest/binary>>, Z1,
			   Z2, TrUserData) ->
    dfp_read_field_def_cancel_match_reply(Rest, Z1, Z2,
					  TrUserData).

d_msg_start_match_reply(Bin, TrUserData) ->
    dfp_read_field_def_start_match_reply(Bin, 0, 0,
					 TrUserData).

dfp_read_field_def_start_match_reply(<<>>, 0, 0, _) ->
    #start_match_reply{};
dfp_read_field_def_start_match_reply(Other, Z1, Z2,
				     TrUserData) ->
    dg_read_field_def_start_match_reply(Other, Z1, Z2,
					TrUserData).

dg_read_field_def_start_match_reply(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_start_match_reply(Rest, N + 7,
					X bsl N + Acc, TrUserData);
dg_read_field_def_start_match_reply(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  skip_varint_start_match_reply(Rest, 0, 0, TrUserData);
      1 -> skip_64_start_match_reply(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_start_match_reply(Rest, 0, 0,
						  TrUserData);
      3 ->
	  skip_group_start_match_reply(Rest, Key bsr 3, 0,
				       TrUserData);
      5 -> skip_32_start_match_reply(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_start_match_reply(<<>>, 0, 0, _) ->
    #start_match_reply{}.

skip_varint_start_match_reply(<<1:1, _:7, Rest/binary>>,
			      Z1, Z2, TrUserData) ->
    skip_varint_start_match_reply(Rest, Z1, Z2, TrUserData);
skip_varint_start_match_reply(<<0:1, _:7, Rest/binary>>,
			      Z1, Z2, TrUserData) ->
    dfp_read_field_def_start_match_reply(Rest, Z1, Z2,
					 TrUserData).

skip_length_delimited_start_match_reply(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_start_match_reply(Rest, N + 7,
					    X bsl N + Acc, TrUserData);
skip_length_delimited_start_match_reply(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_start_match_reply(Rest2, 0, 0,
					 TrUserData).

skip_group_start_match_reply(Bin, FNum, Z2,
			     TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_start_match_reply(Rest, 0, Z2,
					 TrUserData).

skip_32_start_match_reply(<<_:32, Rest/binary>>, Z1, Z2,
			  TrUserData) ->
    dfp_read_field_def_start_match_reply(Rest, Z1, Z2,
					 TrUserData).

skip_64_start_match_reply(<<_:64, Rest/binary>>, Z1, Z2,
			  TrUserData) ->
    dfp_read_field_def_start_match_reply(Rest, Z1, Z2,
					 TrUserData).
...
dfp_read_field_def_match_reply(<<10, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
    d_field_match_reply_start(Rest, Z1, Z2, F@_1, F@_2,
			      TrUserData);
dfp_read_field_def_match_reply(<<18, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
...
d_field_match_reply_start(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_start_match_reply(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_match_reply(RestF, 0, 0,
				   if Prev == undefined -> NewFValue;
				      true ->
					  merge_msg_start_match_reply(Prev,
								      NewFValue,
								      TrUserData)
				   end,
				   F@_2, TrUserData).
...
d_field_match_reply_cancel(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(d_msg_cancel_match_reply(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_match_reply(RestF, 0, 0, F@_1,
				   if Prev == undefined -> NewFValue;
				      true ->
					  merge_msg_cancel_match_reply(Prev,
								       NewFValue,
								       TrUserData)
				   end,
				   TrUserData).
...
dfp_read_field_def_team_member_st(<<8, Rest/binary>>,
				  ...
				  TrUserData) ->
    d_field_team_member_st_role_id(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, TrUserData);
...
dfp_read_field_def_team_member_st(<<>>, 0, 0, F@_1,
    ...
    #team_member_st{role_id = F@_1, state = F@_2,
...
dg_read_field_def_team_member_st(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_team_member_st_role_id(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, F@_5, TrUserData);
      16 ->
...
d_field_team_member_st_role_id(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_team_member_st_role_id(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   TrUserData);
d_field_team_member_st_role_id(<<0:1, X:7,
				 Rest/binary>>,
...
d_field_login_reply_result(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {'d_enum_login_reply.result'(begin
							<<Res:32/signed-native>> =
							    <<(X bsl N +
								 Acc):32/unsigned-native>>,
							Res
...
d_field_create_role_reply_result(<<0:1, X:7,
    ...
    {NewFValue, RestF} =
	{'d_enum_create_role_reply.result'(begin
...
d_msg_notify_msg(Bin, TrUserData) ->
    dfp_read_field_def_notify_msg(Bin, 0, 0, TrUserData).

dfp_read_field_def_notify_msg(<<>>, 0, 0, _) ->
    #notify_msg{};
dfp_read_field_def_notify_msg(Other, Z1, Z2,
			      TrUserData) ->
    dg_read_field_def_notify_msg(Other, Z1, Z2, TrUserData).
...
dg_read_field_def_notify_msg(<<0:1, X:7, Rest/binary>>,
    ...
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> skip_varint_notify_msg(Rest, 0, 0, TrUserData);
      1 -> skip_64_notify_msg(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_notify_msg(Rest, 0, 0,
					   TrUserData);
      3 ->
	  skip_group_notify_msg(Rest, Key bsr 3, 0, TrUserData);
      5 -> skip_32_notify_msg(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_notify_msg(<<>>, 0, 0, _) ->
    #notify_msg{}.

skip_varint_notify_msg(<<1:1, _:7, Rest/binary>>, Z1,
		       Z2, TrUserData) ->
    skip_varint_notify_msg(Rest, Z1, Z2, TrUserData);
skip_varint_notify_msg(<<0:1, _:7, Rest/binary>>, Z1,
		       Z2, TrUserData) ->
    dfp_read_field_def_notify_msg(Rest, Z1, Z2, TrUserData).
...
skip_length_delimited_notify_msg(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_notify_msg(Rest2, 0, 0, TrUserData).

skip_group_notify_msg(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_notify_msg(Rest, 0, Z2, TrUserData).

skip_32_notify_msg(<<_:32, Rest/binary>>, Z1, Z2,
		   TrUserData) ->
    dfp_read_field_def_notify_msg(Rest, Z1, Z2, TrUserData).

skip_64_notify_msg(<<_:64, Rest/binary>>, Z1, Z2,
		   TrUserData) ->
    dfp_read_field_def_notify_msg(Rest, Z1, Z2, TrUserData).
...
dfp_read_field_def_down_msg(<<>>, 0, 0, F@_1, F@_2,
    ...
    #down_msg{error = F@_1, notify = F@_2, login = F@_3,
	      role = F@_4, magic = F@_5, team = F@_6, match = F@_7};
...
d_field_down_msg_notify(<<0:1, X:7, Rest/binary>>, N,
			Acc, F@_1, Prev, F@_3, F@_4, F@_5, F@_6, F@_7,
			TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
...
'd_enum_login_reply.result'(1) -> new_user;
'd_enum_login_reply.result'(2) -> default_role;
'd_enum_login_reply.result'(3) -> role_list;
'd_enum_login_reply.result'(V) -> V.

'd_enum_create_role_reply.result'(0) -> success;
'd_enum_create_role_reply.result'(1) -> nickname_repeat;
'd_enum_create_role_reply.result'(2) -> nickname_error;
'd_enum_create_role_reply.result'(3) -> nickname_dirty;
'd_enum_create_role_reply.result'(V) -> V.
...
merge_msgs(Prev, New, Opts)
    ...
    case Prev of
      ...
      #cancel_match_reply{} ->
	  merge_msg_cancel_match_reply(Prev, New, TrUserData);
      #start_match_reply{} ->
	  merge_msg_start_match_reply(Prev, New, TrUserData);
      #match_reply{} ->
      ...
      #down_msg{} -> merge_msg_down_msg(Prev, New, TrUserData)
    end.
...
merge_msg_cancel_match_reply(_Prev, New, _TrUserData) ->
    New.

merge_msg_start_match_reply(_Prev, New, _TrUserData) ->
    New.

merge_msg_match_reply(#match_reply{start = PFstart,
				   cancel = PFcancel},
		      #match_reply{start = NFstart, cancel = NFcancel},
		      TrUserData) ->
    #match_reply{start =
		     if PFstart /= undefined, NFstart /= undefined ->
			    merge_msg_start_match_reply(PFstart, NFstart,
							TrUserData);
		 ...
		 cancel =
		     if PFcancel /= undefined, NFcancel /= undefined ->
			    merge_msg_cancel_match_reply(PFcancel, NFcancel,
							 TrUserData);
			PFcancel == undefined -> NFcancel;
			NFcancel == undefined -> PFcancel
		     end}.

merge_msg_team_member_st(#team_member_st{role_id =
					     PFrole_id,
					 state = PFstate, elf_id = PFelf_id,
					 name = PFname, level = PFlevel},
			 #team_member_st{role_id = NFrole_id, state = NFstate,
					 elf_id = NFelf_id, name = NFname,
					 level = NFlevel},
			 _) ->
    #team_member_st{role_id =
			if NFrole_id =:= undefined -> PFrole_id;
			   true -> NFrole_id
			end,
		    state =
...
merge_msg_notify_msg(_Prev, New, _TrUserData) -> New.
...
merge_msg_down_msg(#down_msg{error = PFerror,
		   ...
		   #down_msg{error = NFerror, notify = NFnotify,
			     login = NFlogin, role = NFrole, magic = NFmagic,
...
verify_msg(Msg, Opts) ->
    ...
    case Msg of
      ...
      #cancel_match_reply{} ->
	  v_msg_cancel_match_reply(Msg, [cancel_match_reply],
				   TrUserData);
      #start_match_reply{} ->
	  v_msg_start_match_reply(Msg, [start_match_reply],
				  TrUserData);
      #match_reply{} ->
...
-dialyzer({nowarn_function,v_msg_cancel_match_reply/3}).
v_msg_cancel_match_reply(#cancel_match_reply{}, _Path,
			 _) ->
    ok;
v_msg_cancel_match_reply(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, cancel_match_reply}, X,
		  Path).

-dialyzer({nowarn_function,v_msg_start_match_reply/3}).
v_msg_start_match_reply(#start_match_reply{}, _Path,
			_) ->
    ok;
v_msg_start_match_reply(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, start_match_reply}, X,
		  Path).
...
v_msg_match_reply(#match_reply{start = F1, cancel = F2},
    ...
    if F1 == undefined -> ok;
       true ->
	   v_msg_start_match_reply(F1, [start | Path], TrUserData)
    end,
    if F2 == undefined -> ok;
       true ->
	   v_msg_cancel_match_reply(F2, [cancel | Path],
				    TrUserData)
    end,
    ok;
...
v_msg_team_member_st(#team_member_st{role_id = F1,
				     state = F2, elf_id = F3, name = F4,
				     level = F5},
		     Path, _) ->
    if F1 == undefined -> ok;
    ...
    if F5 == undefined -> ok;
       true -> v_type_int32(F5, [level | Path])
    end,
    ok;
...
v_msg_login_reply(#login_reply{result = F1,
			       user_id = F2, role = F3, roles = F4},
		  Path, TrUserData) ->
    'v_enum_login_reply.result'(F1, [result | Path]),
...
v_msg_create_role_reply(#create_role_reply{result = F1,
					   role = F2},
			Path, TrUserData) ->
    'v_enum_create_role_reply.result'(F1, [result | Path]),
    if F2 == undefined -> ok;
...
v_msg_notify_msg(#notify_msg{}, _Path, _) -> ok;
...
v_msg_down_msg(#down_msg{error = F1, notify = F2,
    ...
    if F5 == undefined -> ok;
       true ->
	   v_msg_magic_reply(F5, [magic | Path], TrUserData)
    end,
    if F6 == undefined -> ok;
       true -> v_msg_team_reply(F6, [team | Path], TrUserData)
    end,
    if F7 == undefined -> ok;
       true ->
	   v_msg_match_reply(F7, [match | Path], TrUserData)
    end,
    ok.
...
-dialyzer({nowarn_function,'v_enum_login_reply.result'/2}).
'v_enum_login_reply.result'(new_user, _Path) -> ok;
'v_enum_login_reply.result'(default_role, _Path) -> ok;
'v_enum_login_reply.result'(role_list, _Path) -> ok;
'v_enum_login_reply.result'(V, Path)
    when is_integer(V) ->
    v_type_sint32(V, Path);
'v_enum_login_reply.result'(X, Path) ->
    mk_type_error({invalid_enum, 'login_reply.result'}, X,
		  Path).

-dialyzer({nowarn_function,'v_enum_create_role_reply.result'/2}).
'v_enum_create_role_reply.result'(success, _Path) -> ok;
'v_enum_create_role_reply.result'(nickname_repeat,
				  _Path) ->
    ok;
'v_enum_create_role_reply.result'(nickname_error,
				  _Path) ->
    ok;
'v_enum_create_role_reply.result'(nickname_dirty,
				  _Path) ->
    ok;
'v_enum_create_role_reply.result'(V, Path)
    when is_integer(V) ->
    v_type_sint32(V, Path);
'v_enum_create_role_reply.result'(X, Path) ->
    mk_type_error({invalid_enum,
		   'create_role_reply.result'},
		  X, Path).
...
get_msg_defs() ->
    [{{enum, result}, [{success, 0}, {fail, 1}]},
     {{enum, 'login_reply.result'},
      [{new_user, 1}, {default_role, 2}, {role_list, 3}]},
     {{enum, 'create_role_reply.result'},
     ...
     {{msg, role_st},
      [#field{name = role_id, fnum = 1, rnum = 2,
       ...
       #field{name = exp, fnum = 5, rnum = 6, type = uint32,
	      occurrence = optional, opts = []}]},
     {{msg, cancel_match_reply}, []},
     {{msg, start_match_reply}, []},
     {{msg, match_reply},
      [#field{name = start, fnum = 1, rnum = 2,
	      type = {msg, start_match_reply}, occurrence = optional,
	      opts = []},
       #field{name = cancel, fnum = 2, rnum = 3,
	      type = {msg, cancel_match_reply}, occurrence = optional,
	      opts = []}]},
     {{msg, team_member_st},
      [#field{name = role_id, fnum = 1, rnum = 2,
	      type = uint32, occurrence = optional, opts = []},
     ...
     {{msg, create_role_reply},
      [#field{name = result, fnum = 1, rnum = 2,
	      type = {enum, 'create_role_reply.result'},
	      occurrence = required, opts = []},
     ...
     {{msg, down_msg},
      [#field{name = error, fnum = 1, rnum = 2,
       ...
       #field{name = role, fnum = 4, rnum = 5,
	      ...
	      opts = []},
       #field{name = magic, fnum = 5, rnum = 6,
	      type = {msg, magic_reply}, occurrence = optional,
	      opts = []},
       #field{name = team, fnum = 6, rnum = 7,
	      type = {msg, team_reply}, occurrence = optional,
	      opts = []},
       #field{name = match, fnum = 7, rnum = 8,
	      type = {msg, match_reply}, occurrence = optional,
	      opts = []}]}].


get_msg_names() ->
    [name_card_st, role_st, cancel_match_reply,
     start_match_reply, match_reply, team_member_st,
     team_info_st, team_reply, select_magic_reply,
     lookup_role_reply, role_summary_st, login_reply,
     magic_reply, select_role_reply, create_role_reply,
     role_reply, notify_msg, error_info, down_msg].
...
get_enum_names() ->
    [result, 'login_reply.result',
     'create_role_reply.result', team_member_state].
...
find_msg_def(role_st) ->
    [#field{name = role_id, fnum = 1, rnum = 2,
     ...
     #field{name = exp, fnum = 5, rnum = 6, type = uint32,
	    occurrence = optional, opts = []}];
find_msg_def(cancel_match_reply) -> [];
find_msg_def(start_match_reply) -> [];
...
find_enum_def('login_reply.result') ->
    [{new_user, 1}, {default_role, 2}, {role_list, 3}];
find_enum_def('create_role_reply.result') ->
    [{success, 0}, {nickname_repeat, 1},
     {nickname_error, 2}, {nickname_dirty, 3}];
...
enum_symbol_by_value('login_reply.result', Value) ->
    'enum_symbol_by_value_login_reply.result'(Value);
enum_symbol_by_value('create_role_reply.result',
		     Value) ->
    'enum_symbol_by_value_create_role_reply.result'(Value);
...
enum_value_by_symbol('login_reply.result', Sym) ->
    'enum_value_by_symbol_login_reply.result'(Sym);
enum_value_by_symbol('create_role_reply.result', Sym) ->
    'enum_value_by_symbol_create_role_reply.result'(Sym);
...
'enum_symbol_by_value_login_reply.result'(1) ->
    new_user;
'enum_symbol_by_value_login_reply.result'(2) ->
    default_role;
'enum_symbol_by_value_login_reply.result'(3) ->
    role_list.


'enum_value_by_symbol_login_reply.result'(new_user) ->
    1;
'enum_value_by_symbol_login_reply.result'(default_role) ->
    2;
'enum_value_by_symbol_login_reply.result'(role_list) ->
    3.

'enum_symbol_by_value_create_role_reply.result'(0) ->
    success;
'enum_symbol_by_value_create_role_reply.result'(1) ->
    nickname_repeat;
'enum_symbol_by_value_create_role_reply.result'(2) ->
    nickname_error;
'enum_symbol_by_value_create_role_reply.result'(3) ->
    nickname_dirty.


'enum_value_by_symbol_create_role_reply.result'(success) ->
    0;
'enum_value_by_symbol_create_role_reply.result'(nickname_repeat) ->
    1;
'enum_value_by_symbol_create_role_reply.result'(nickname_error) ->
    2;
'enum_value_by_symbol_create_role_reply.result'(nickname_dirty) ->
    3.

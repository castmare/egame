...
-export_type(['team_state'/0, 'create_role'/0, 'name_card_st'/0, 'role_st'/0, 'team_leave'/0, 'team_refuse'/0, 'team_accept'/0, 'team_invite'/0, 'team_req'/0, 'start_match'/0, 'team_member_st'/0, 'cancel_match'/0, 'role_summary_st'/0, 'match_req'/0, 'select_magic'/0, 'magic_req'/0, 'lookup_role'/0, 'select_role'/0, 'role_req'/0, 'login_req'/0, 'sdk_login_req'/0, 'up_msg'/0, 'team_info_st'/0]).

-spec encode_msg(#team_state{} | #create_role{} | #name_card_st{} | #role_st{} | #team_leave{} | #team_refuse{} | #team_accept{} | #team_invite{} | #team_req{} | #start_match{} | #team_member_st{} | #cancel_match{} | #role_summary_st{} | #match_req{} | #select_magic{} | #magic_req{} | #lookup_role{} | #select_role{} | #role_req{} | #login_req{} | #sdk_login_req{} | #up_msg{} | #team_info_st{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#team_state{} | #create_role{} | #name_card_st{} | #role_st{} | #team_leave{} | #team_refuse{} | #team_accept{} | #team_invite{} | #team_req{} | #start_match{} | #team_member_st{} | #cancel_match{} | #role_summary_st{} | #match_req{} | #select_magic{} | #magic_req{} | #lookup_role{} | #select_role{} | #role_req{} | #login_req{} | #sdk_login_req{} | #up_msg{} | #team_info_st{}, list()) -> binary().
encode_msg(Msg, Opts) ->
...
e_msg_up_msg(#up_msg{sequence = F1, repeat = F2,
		     ...
		     role = F7, magic = F8, team = F9, match = F10},
	     Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   e_varint(TrF1, <<Bin/binary, 8>>)
    ...
    B8 = if F8 == undefined -> B7;
		...
		begin
		  ...
		  e_mfield_up_msg_magic(TrF8, <<B7/binary, 66>>,
					TrUserData)
		end
	 end,
    B9 = if F9 == undefined -> B8;
		...
		begin
		  ...
		  e_mfield_up_msg_team(TrF9, <<B8/binary, 74>>,
				       TrUserData)
		end
	 end,
    if F10 == undefined -> B9;
	   ...
	   begin
	     ...
	     e_mfield_up_msg_match(TrF10, <<B9/binary, 82>>,
				   TrUserData)
	   end
    end.
...
dfp_read_field_def_up_msg(<<>>, 0, 0, F@_1, F@_2, F@_3,
    ...
    #up_msg{sequence = F@_1, repeat = F@_2, user_id = F@_3,
	    ...
	    role = F@_7, magic = F@_8, team = F@_9, match = F@_10};
...
merge_msg_up_msg(#up_msg{sdk_login = PFsdk_login,
			 login = PFlogin, role = PFrole, magic = PFmagic,
		 ...
		 #up_msg{sequence = NFsequence, repeat = NFrepeat,
			 ...
			 role = NFrole, magic = NFmagic, team = NFteam,
			 match = NFmatch},
		 TrUserData) ->
    #up_msg{sequence = NFsequence, repeat = NFrepeat,
	    user_id = NFuser_id, role_id = NFrole_id,
...
v_msg_up_msg(#up_msg{sequence = F1, repeat = F2,
    ...
    if F8 == undefined -> ok;
       true -> v_msg_magic_req(F8, [magic | Path], TrUserData)
    end,
    if F9 == undefined -> ok;
       true -> v_msg_team_req(F9, [team | Path], TrUserData)
    end,
    if F10 == undefined -> ok;
       true -> v_msg_match_req(F10, [match | Path], TrUserData)
    end,
    ok.
     ...
     {{msg, role_st},
      [#field{name = role_id, fnum = 1, rnum = 2,
       ...
       #field{name = exp, fnum = 5, rnum = 6, type = uint32,
	      occurrence = optional, opts = []}]},
     {{msg, team_leave}, []}, {{msg, team_refuse}, []},
     {{msg, team_accept}, []},
     {{msg, team_invite},
      [#field{name = role_id, fnum = 1, rnum = 2,
	      type = uint32, occurrence = required, opts = []}]},
     ...
     {{msg, up_msg},
      [#field{name = sequence, fnum = 1, rnum = 2,
       ...
       #field{name = role, fnum = 7, rnum = 8,
	      ...
	      opts = []},
       #field{name = magic, fnum = 8, rnum = 9,
	      type = {msg, magic_req}, occurrence = optional,
	      opts = []},
       #field{name = team, fnum = 9, rnum = 10,
	      type = {msg, team_req}, occurrence = optional,
	      opts = []},
       #field{name = match, fnum = 10, rnum = 11,
...
get_msg_names() ->
    [team_state, create_role, name_card_st, role_st,
     team_leave, team_refuse, team_accept, team_invite,
     team_req, start_match, team_member_st, cancel_match,
     role_summary_st, match_req, select_magic, magic_req,
     lookup_role, select_role, role_req, login_req,
     sdk_login_req, up_msg, team_info_st].

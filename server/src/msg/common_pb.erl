...
-export_type(['team_member_st'/0, 'team_info_st'/0, 'name_card_st'/0, 'role_summary_st'/0, 'role_st'/0]).

-spec encode_msg(#team_member_st{} | #team_info_st{} | #name_card_st{} | #role_summary_st{} | #role_st{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#team_member_st{} | #team_info_st{} | #name_card_st{} | #role_summary_st{} | #role_st{}, list()) -> binary().
encode_msg(Msg, Opts) ->
...
get_msg_names() ->
    [team_member_st, team_info_st, name_card_st,
     role_summary_st, role_st].

...
RTNOTIFY_PORT=$(($MAIN_PORT+2))
BATTLE_PORT=$(($MAIN_PORT+3))
...
SED_ENV+=" s/'?rtnotify_port'/${RTNOTIFY_PORT}/g;"
SED_ENV+=" s/'?battle_ip'/${BATTLE_IP}/g;"
SED_ENV+=" s/'?battle_port'/${BATTLE_PORT}/g;"

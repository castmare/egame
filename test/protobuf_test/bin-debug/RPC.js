...
var RPC = (function () {
    ...
    RPC.Call = function (upField, data, replyCallBack) {
        ...
        var decoded = this.upMsgClass.decode(encodeData);
        RPC.Request(encodeData, replyCallBack);
    };
    ...
    RPC.Request = function (data, replyCallBack) {
        return __awaiter(this, void 0, void 0, function () {
            var net, reqData, promise, result, ReplyMsg, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        net = new Network();
                        reqData = this.WrapProtoData(data);
                        ...
                        promise = function (time) {
                            return new Promise(function (resolve, reject) {
                                ...
                                net.Connect("192.168.5.7", 13001, function (so) {
                                    ...
                                    so.writeBytes(new egret.ByteArray(reqData));
                                }, function (so) {

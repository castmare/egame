...
var LoginScene = (function (_super) {
    ...
    LoginScene.prototype.login = function () {
        var _this = this;
        RPC.Call("login", { device_id: DS.get(DataKey.DEVICE), version: "1.0.0" }, function (reply) { _this.onLoginReply(reply); });
        // let reply = JSON.parse(`
        //     {"login":{"result":3,"user_id":67,"roles":[{"role_id":671,"elf_id":1001,"name":"我是火精灵","level":1},{"role_id":671,"elf_id":1002,"name":"我是水精灵","level":1},{"role_id":671,"elf_id":1003,"name":"我是土精灵","level":1}]}}
        // `);
